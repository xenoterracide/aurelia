...
type IContainerDomainProbeContext<K extends Key> = {
  key: K;
...
export class Container implements IContainer {
  ...
  public getContainerPath(): string {
    return this.parent === null ? `${this.name} >` : this.name;
  }
...
export class ContainerTracerDomainProbe implements IContainerDomainProbe {
